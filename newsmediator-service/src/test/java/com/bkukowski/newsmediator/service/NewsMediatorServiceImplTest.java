...
class NewsMediatorServiceImplTest {
    ...
    public void init() {
        ...
        ReflectionTestUtils.setField(urlProvider, "apiKey", "dupa");
    }
    ...
    void whenValidCountryAndCategory_thenNewsShouldBeReturned() throws URISyntaxException {
        ...
        mockServer.expect(ExpectedCount.once(),
                requestTo(new URI("https://newsapi.org/v2/top-headlines?country=pl&category=technology&pageSize=100&dupa")))
        ...
        Assertions.assertThat(newsByCountryAndCategory.getArticles()).hasSize(2);
    }
